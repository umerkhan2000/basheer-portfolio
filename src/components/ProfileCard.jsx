      ...
      <section ref={cardRef} className="pc-card">
        <div className="pc-inside">
          ...
          <div className="pc-content pc-avatar-content">
            <div className="pc-image-container">
              <img
                ...
                style={{ 
                  ...
                  border: 'none',
                  background: 'none',
                  filter: 'brightness(1.2) contrast(1.1)', // Enhance image
                  zIndex: 10
                }}
                ...
                onError={e => {
                  ...
                  target.alt = 'Profile Image';
                }}
              />
              
              {/* Overlay status and link on the image */}
              {showUserInfo && (
            ...
            {showUserInfo && (
              <div className="pc-user-info" style={{ display: 'none' }}>
